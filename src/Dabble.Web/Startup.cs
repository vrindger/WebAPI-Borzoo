using System;
using Dabble.Web.Data;
using Dabble.Web.Middlewares.BasicAuth;
...
namespace Dabble.Web
{
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.Run(context => context.Response.WriteAsync("Hello, World! Welcome to Dabble ;)"));
        }
    }
}
